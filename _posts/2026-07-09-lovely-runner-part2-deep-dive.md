...
image:
  ...
  alt: "Lovely Runner Deep Dive Spoilers"
featured: false
---
...
> - [**Part 1 — Spoiler-Free Introduction →**]({{ site.baseurl }}/posts/lovely-runner-part1-intro/)
...
![Sol and Sun-jae's buried time capsule](/assets/img/posts/lovely-runner-windup-clock.jpg)
...
- [Editor's Masterpiece Walk — Goblin (도깨비) →]({{ site.baseurl }}/posts/goblin-deep-dive/)
- [Queen of Tears — 2024's Biggest K-Drama →]({{ site.baseurl }}/posts/queen-of-tears-part1-intro/)
